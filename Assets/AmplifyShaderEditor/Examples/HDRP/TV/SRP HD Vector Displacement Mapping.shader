...
Shader "ASESampleShaders/SRP/Vector Displacement Mapping"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv013 = inputMesh.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D11 = snoise( uv013*sin( _TimeParameters.x * 0.25 ) );
				...
				float2 uv0172 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + appendResult171;
				float2 SkullWave175 = uv0172;
				...
				float2 uv099 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + appendResult110;
				float2 LeftHandWave103 = uv099;
						...
						)
			{
				...
				float2 temp_cast_0 = (_NoiseTiling).xx;
				float2 uv013 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D11 = snoise( uv013*sin( _TimeParameters.x * 0.25 ) );
				simplePerlin2D11 = simplePerlin2D11*0.5 + 0.5;
				float BasicNoise116 = simplePerlin2D11;
				float2 appendResult171 = (float2(( 0.11 * BasicNoise116 ) , ( BasicNoise116 * 0.04 )));
				float2 uv0172 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + appendResult171;
				float2 SkullWave175 = uv0172;
				...
				float2 appendResult110 = (float2(( -0.01 * BasicNoise116 ) , ( simplePerlin2D11 * 0.04 )));
				float2 uv099 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + appendResult110;
				float2 LeftHandWave103 = uv099;
				...
				float2 uv0206 = packedInput.ase_texcoord5.xy * float2( 3,3 ) + float2( 0,0 );
				...
				// Flipbook UV
				half2 fbuv205 = uv0206 * fbtiling205 + fboffset205;
				...
				float2 uv0235 = packedInput.ase_texcoord5.xy * temp_cast_2 + float2( 0,0 );
				float simplePerlin2D237 = snoise( uv0235*_TimeParameters.y );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float4 appendResult5 = (float4(tex2DNode6.r , tex2DNode6.b , tex2DNode6.g , 0.0));
				float2 temp_cast_0 = (_NoiseTiling).xx;
				float2 uv013 = inputMesh.uv0.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D11 = snoise( uv013*sin( _TimeParameters.x * 0.25 ) );
				simplePerlin2D11 = simplePerlin2D11*0.5 + 0.5;
				float BasicNoise116 = simplePerlin2D11;
				...
				float3 tangentTobjectDir4 = mul( GetWorldToObjectMatrix(), float4( mul( ase_tangentToWorldFast, ( ( appendResult5 * BasicNoise116 ) * MaskR15 ).xyz ), 0 ) ).xyz;
				float2 appendResult171 = (float2(( 0.11 * BasicNoise116 ) , ( BasicNoise116 * 0.04 )));
				float2 uv0172 = inputMesh.uv0.xy * float2( 1,1 ) + appendResult171;
				float2 SkullWave175 = uv0172;
				float4 tex2DNode35 = tex2Dlod( _TopSkullVDM, float4( SkullWave175, 0, 0.0) );
				float4 appendResult36 = (float4(tex2DNode35.r , tex2DNode35.b , tex2DNode35.g , 0.0));
				float MaskG63 = tex2DNode45.g;
				...
				float3 lerpResult72 = lerp( ( tangentTobjectDir4 * _HandIntensity ) , ( tangentTobjectDir38 * _SkullIntensity ) , MaskG63);
				float2 appendResult110 = (float2(( -0.01 * BasicNoise116 ) , ( simplePerlin2D11 * 0.04 )));
				float2 uv099 = inputMesh.uv0.xy * float2( 1,1 ) + appendResult110;
				float2 LeftHandWave103 = uv099;
				float4 tex2DNode77 = tex2Dlod( _LeftHandVDM, float4( LeftHandWave103, 0, 0.0) );
				float4 appendResult78 = (float4(tex2DNode77.r , tex2DNode77.b , tex2DNode77.g , 0.0));
				float MaskB84 = tex2DNode45.b;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float SkullIntensity51 = _SkullIntensity;
				float2 temp_cast_0 = (_NoiseTiling).xx;
				float2 uv013 = packedInput.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D11 = snoise( uv013*sin( _TimeParameters.x * 0.25 ) );
				simplePerlin2D11 = simplePerlin2D11*0.5 + 0.5;
				float BasicNoise116 = simplePerlin2D11;
				float2 appendResult171 = (float2(( 0.11 * BasicNoise116 ) , ( BasicNoise116 * 0.04 )));
				float2 uv0172 = packedInput.ase_texcoord.xy * float2( 1,1 ) + appendResult171;
				float2 SkullWave175 = uv0172;
				float4 tex2DNode35 = tex2D( _TopSkullVDM, SkullWave175 );
				float TopSkullColorMask66 = tex2DNode35.g;
				float clampResult59 = clamp( ( ( SkullIntensity51 * 0.5 ) * TopSkullColorMask66 ) , 0.0 , 0.5 );
				...
				float SideHandIntensity75 = _SideHandIntensity;
				float2 appendResult110 = (float2(( -0.01 * BasicNoise116 ) , ( simplePerlin2D11 * 0.04 )));
				float2 uv099 = packedInput.ase_texcoord.xy * float2( 1,1 ) + appendResult110;
				float2 LeftHandWave103 = uv099;
				float4 tex2DNode77 = tex2D( _LeftHandVDM, LeftHandWave103 );
				float SideHandColorMask80 = tex2DNode77.g;
				float clampResult93 = clamp( ( ( SideHandIntensity75 * 0.5 ) * SideHandColorMask80 ) , 0.0 , 0.5 );
				float4 lerpResult94 = lerp( lerpResult56 , _SideHandTint , clampResult93);
				float2 uv0206 = packedInput.ase_texcoord.xy * float2( 3,3 ) + float2( 0,0 );
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles205 = 2.0 * 2.0;
				// Offsets for cols and rows of Flipbook Texture
				...
				float4 TVNoise214 = temp_output_209_0;
				float2 temp_cast_2 = (_TilingGlow).xx;
				float2 uv0235 = packedInput.ase_texcoord.xy * temp_cast_2 + float2( 0,0 );
				float simplePerlin2D237 = snoise( uv0235*_TimeParameters.y );
				simplePerlin2D237 = simplePerlin2D237*0.5 + 0.5;
				float HandMaskNoiseEmission263 = clampResult259;
		...
		Pass
		{
					...
					)
			{
				...
				unpack21.z = lerp( 1, unpack21.z, saturate(clampResult32) );
				float2 temp_cast_0 = (_NoiseTiling).xx;
				float2 uv013 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D11 = snoise( uv013*sin( _TimeParameters.x * 0.25 ) );
				simplePerlin2D11 = simplePerlin2D11*0.5 + 0.5;
				float BasicNoise116 = simplePerlin2D11;
				float2 appendResult171 = (float2(( 0.11 * BasicNoise116 ) , ( BasicNoise116 * 0.04 )));
				float2 uv0172 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + appendResult171;
				float2 SkullWave175 = uv0172;
				float SkullIntensity51 = _SkullIntensity;
				float clampResult53 = clamp( SkullIntensity51 , 0.0 , 1.0 );
				float3 unpack50 = UnpackNormalScale( tex2D( _NormalTopSkull, SkullWave175 ), clampResult53 );
				unpack50.z = lerp( 1, unpack50.z, saturate(clampResult53) );
				float2 appendResult110 = (float2(( -0.01 * BasicNoise116 ) , ( simplePerlin2D11 * 0.04 )));
				float2 uv099 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + appendResult110;
				float2 LeftHandWave103 = uv099;
				float SideHandIntensity75 = _SideHandIntensity;
				float clampResult98 = clamp( SideHandIntensity75 , 0.0 , 1.0 );
				float3 unpack96 = UnpackNormalScale( tex2D( _NormalsLeftHand, LeftHandWave103 ), clampResult98 );
		...
		Pass
		{
						...
						)
			{
				...
				float SkullIntensity51 = _SkullIntensity;
				float2 temp_cast_0 = (_NoiseTiling).xx;
				float2 uv013 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D11 = snoise( uv013*sin( _TimeParameters.x * 0.25 ) );
				simplePerlin2D11 = simplePerlin2D11*0.5 + 0.5;
				float BasicNoise116 = simplePerlin2D11;
				float2 appendResult171 = (float2(( 0.11 * BasicNoise116 ) , ( BasicNoise116 * 0.04 )));
				float2 uv0172 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + appendResult171;
				float2 SkullWave175 = uv0172;
				float4 tex2DNode35 = tex2D( _TopSkullVDM, SkullWave175 );
				float TopSkullColorMask66 = tex2DNode35.g;
				float clampResult59 = clamp( ( ( SkullIntensity51 * 0.5 ) * TopSkullColorMask66 ) , 0.0 , 0.5 );
				...
				float SideHandIntensity75 = _SideHandIntensity;
				float2 appendResult110 = (float2(( -0.01 * BasicNoise116 ) , ( simplePerlin2D11 * 0.04 )));
				float2 uv099 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + appendResult110;
				float2 LeftHandWave103 = uv099;
				float4 tex2DNode77 = tex2D( _LeftHandVDM, LeftHandWave103 );
				float SideHandColorMask80 = tex2DNode77.g;
				float clampResult93 = clamp( ( ( SideHandIntensity75 * 0.5 ) * SideHandColorMask80 ) , 0.0 , 0.5 );
				float4 lerpResult94 = lerp( lerpResult56 , _SideHandTint , clampResult93);
				float2 uv0206 = packedInput.ase_texcoord7.xy * float2( 3,3 ) + float2( 0,0 );
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles205 = 2.0 * 2.0;
				// Offsets for cols and rows of Flipbook Texture
				...
				float4 TVNoise214 = temp_output_209_0;
				float2 temp_cast_2 = (_TilingGlow).xx;
				float2 uv0235 = packedInput.ase_texcoord7.xy * temp_cast_2 + float2( 0,0 );
				float simplePerlin2D237 = snoise( uv0235*_TimeParameters.y );
				simplePerlin2D237 = simplePerlin2D237*0.5 + 0.5;
				float HandMaskNoiseEmission263 = clampResult259;
...
/*ASEBEGIN
Version=18300
-1346;-490;1186;624;11023.45;4974.354;13.15998;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-4475.466,2683.829;Inherit;False;Property;_NoiseTiling;Noise Tiling;4;0;Create;True;0;0;False;0;False;1;1.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;174;-3470.356,2165.14;Inherit;False;Constant;_Float1;Float 1;19;0;Create;True;0;0;False;0;False;0.04;0.04;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;173;-3425.921,1910.387;Inherit;False;Constant;_Float3;Float 3;16;0;Create;True;0;0;False;0;False;0.11;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;108;-3258.272,2897.576;Inherit;False;Constant;_Float0;Float 0;18;0;Create;True;0;0;False;0;False;0.04;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;111;-3267.837,2647.823;Inherit;False;Constant;_Float2;Float 2;14;0;Create;True;0;0;False;0;False;-0.01;-0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1337.964,1653.288;Inherit;False;Property;_HandIntensity;Hand Intensity;1;0;Create;True;0;0;False;0;False;0;1.059;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;6;-2519.142,1445.017;Inherit;True;Property;_ScreenHandsVDM;Screen Hands VDM;20;0;Create;True;0;0;False;0;False;-1;None;821049934f0b08f43b59f0e83855b872;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;212;-2418.346,-2344.583;Inherit;False;Constant;_Float5;Float 5;17;0;Create;True;0;0;False;0;False;12;12;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1451.203,2222.564;Inherit;False;Property;_SkullIntensity;Skull Intensity;2;0;Create;True;0;0;False;0;False;0;0;0;1.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;208;-2425.938,-2441.429;Inherit;False;Constant;_Float4;Float 4;18;0;Create;True;0;0;False;0;False;2;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;45;-2586.625,-1180.15;Inherit;True;Property;_Masks;Masks;8;0;Create;True;0;0;False;0;False;-1;9670904ec41723446943d2bfc39209fa;9670904ec41723446943d2bfc39209fa;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-1465.784,2886.284;Inherit;False;Property;_SideHandIntensity;Side Hand Intensity;3;0;Create;True;0;0;False;0;False;0;1.5;0;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;35;-2215.984,1994.756;Inherit;True;Property;_TopSkullVDM;Top Skull VDM;21;0;Create;True;0;0;False;0;False;-1;None;6c5beca9a2811f54e8e341880e84b0d3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;203;-1886.771,-2413.138;Inherit;True;Property;_NoiseFlipbook;Noise Flipbook;16;0;Create;True;0;0;False;0;False;-1;None;12c89afe141ffb44db0961b50bfb0d10;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;77;-2175.563,2655.475;Inherit;True;Property;_LeftHandVDM;Left Hand VDM;22;0;Create;True;0;0;False;0;False;-1;None;bb176a5ceabe4274b8868f4a3c27d7ca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;234;-2463.243,675.1545;Inherit;False;Property;_TilingGlow;Tiling Glow;5;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;241;-2369.934,-2093.861;Inherit;False;Property;_ScreenToggle;Screen Toggle;0;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;221;-2322.818,481.376;Inherit;False;Property;_GlowIntensity;Glow Intensity;17;1;[HDR];Create;True;0;0;False;0;False;0;0.33;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;219;-2347.196,306.9973;Inherit;False;Property;_NoiseTint;Noise Tint;18;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;1.014418,1.157659,1.54717,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-2501.284,-4266.573;Inherit;True;Property;_Albedo;Albedo;7;0;Create;True;0;0;False;0;False;-1;None;fee3d6c66c9f7fc4294caf4caefc054e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;57;-2221.236,-3829.968;Inherit;False;Property;_TopSkullTint;Top Skull Tint;10;0;Create;True;0;0;False;0;False;0,0,0,0;0.5188676,0.4674706,0.4674706,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;92;-1907.106,-3238.74;Inherit;False;Property;_SideHandTint;Side Hand Tint;11;0;Create;True;0;0;False;0;False;0,0,0,0;0.9622641,0.5155641,0.3131887,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;305;-1464.403,-1510.935;Inherit;False;Property;_ScreenColorTintBlend;Screen Color Tint Blend;23;0;Create;True;0;0;False;0;False;0;0.5647059;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;96;-2015.594,-230.9689;Inherit;True;Property;_NormalsLeftHand;Normals Left Hand;13;0;Create;True;0;0;False;0;False;-1;38c34d9a83dd163439364888ad5eda23;38c34d9a83dd163439364888ad5eda23;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;50;-2014.889,-455.0049;Inherit;True;Property;_NormalTopSkull;Normal Top Skull;9;0;Create;True;0;0;False;0;False;-1;None;c3039ffc5e0516b44b5b7b599a16367d;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;253;-1728.019,-1899.992;Inherit;False;Property;_TVHandsTint;TV Hands Tint;19;0;Create;True;0;0;False;0;False;0,0,0,0;0.745283,0.745283,0.745283,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-2040.353,-896.5031;Inherit;True;Property;_Normal;Normal;12;0;Create;True;0;0;False;0;False;-1;None;70c247db5b217844dab975e0fe9786a8;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;21;-2031.967,-680.7849;Inherit;True;Property;_NormalHands;Normal Hands;6;0;Create;True;0;0;False;0;False;-1;1d75b14f4f330394b905e928ac14c061;1d75b14f4f330394b905e928ac14c061;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;261;-665.5458,734.897;Inherit;False;Property;_BaseSmoothness;Base Smoothness;15;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;202;-687.998,528.3009;Inherit;True;Property;_TV_MetallicSmoothness;TV_MetallicSmoothness;14;0;Create;True;0;0;False;0;False;-1;5d7beef2bf536ce4787fd5b796ced093;5d7beef2bf536ce4787fd5b796ced093;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;307;311.9513,1943.607;Inherit;False;Property;_DisplacementMultiplier;Displacement Multiplier;24;0;Create;True;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=915E78B73D44E5F954716E96B7591EBAF2736AE1