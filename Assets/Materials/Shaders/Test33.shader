	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VertexOut82 = ( _Enablepulsation * ( ( _PulsationAmplitude / 100.0 ) * ( sin( ( _PulsationSpeed * _TimeParameters.x ) ) * inputMesh.normalOS ) ) );
						...
						)
			{
				...
				float2 panner23 = ( _TimeParameters.x * _Mainpanningspeed + uv016);
				float3 desaturateInitialColor32 = tex2D( _Maintexture, panner23 ).rgb;
				...
				float4 MainTexture60 = ( _Maintextureintensity * float4( ( ( _Invertmaintexture * ( 1.0 - desaturateVar32 ) ) + ( ( 1.0 - _Invertmaintexture ) * desaturateVar32 ) ) , 0.0 ) * _Maincolor );
				float2 uv021 = packedInput.ase_texcoord5.xy * _SecondaryTextureTiling + float2( 0,0 );
				float2 panner24 = ( _TimeParameters.x * _Secondarypanningspeed + uv021);
				float3 desaturateInitialColor31 = tex2D( _Secondarytexture, panner24 ).rgb;
				...
				float4 SecondaryTexture58 = ( _Secondarytextureintensity * float4( ( ( _Invertsecondarytexture * ( 1.0 - desaturateVar31 ) ) + ( ( 1.0 - _Invertsecondarytexture ) * desaturateVar31 ) ) , 0.0 ) * _Secondarycolor );
				float fresnelNdotV25 = dot( normalWS, V );
				float fresnelNode25 = ( _Bias + _Scale * pow( 1.0 - fresnelNdotV25, _Power ) );
				float clampResult43 = clamp( ( ( _Outerfresnelintensity * fresnelNode25 ) + ( ( 1.0 - fresnelNode25 ) * _Innerfresnelintensity ) ) , 0.0 , 1.0 );
				float FresnelMask48 = clampResult43;
				float4 Fresnel59 = ( FresnelMask48 * _Edgecolor );
				
				surfaceDescription.Albedo = ( ( MainTexture60 + SecondaryTexture58 + Fresnel59 ) * _Globalopacity ).rgb;
				...
				surfaceDescription.Alpha = ( _Globalopacity * FresnelMask48 );
...
/*ASEBEGIN
Version=18300
-1380;22;1248;882;3123.321;784.9347;1;True;True
...
Node;AmplifyShaderEditor.Vector2Node;83;-2658.113,404.1028;Inherit;False;Property;_SecondaryTextureTiling;SecondaryTextureTiling;20;0;Create;True;0;0;False;0;False;0,3;5,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1821.013,1163.908;Float;False;Property;_Bias;Bias;7;0;Create;True;0;0;False;0;False;0;-2.74;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;15;-2291.774,-282.2797;Float;False;Property;_Mainpanningspeed;Main panning speed;3;0;Create;True;0;0;False;0;False;0,0;0.01,0.04;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1931.812,1342.372;Float;False;Property;_Power;Power;9;0;Create;True;0;0;False;0;False;2;0.79;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;22;-2317.042,555.176;Float;False;Property;_Secondarypanningspeed;Secondary panning speed;14;0;Create;True;0;0;False;0;False;0,0;-0.001,0.05;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;19;-1828.639,1252.337;Float;False;Property;_Scale;Scale;8;0;Create;True;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;26;-1741.743,571.397;Inherit;True;Property;_Secondarytexture;Secondary texture;12;0;Create;True;0;0;False;0;False;-1;None;1bb439ef25adc154f89dcd96e4d581aa;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;30;-1329.898,1220.162;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1610.858,1400.652;Float;False;Property;_Innerfresnelintensity;Inner fresnel intensity;10;0;Create;True;0;0;False;0;False;0;0.415;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-1634.302,1069.336;Float;False;Property;_Outerfresnelintensity;Outer fresnel intensity;11;0;Create;True;0;0;False;0;False;1;0.626;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;28;-1761.06,-248.4896;Inherit;True;Property;_Maintexture;Main texture;1;0;Create;True;0;0;False;0;False;-1;None;f543c7176452fb240a4464117a622491;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-1504.291,261.4376;Float;False;Property;_Invertsecondarytexture;Invert secondary texture;15;1;[Toggle];Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1500.772,-498.5397;Float;False;Property;_Invertmaintexture;Invert main texture;4;1;[Toggle];Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-1561.264,1962.712;Float;False;Property;_PulsationSpeed;Pulsation Speed;19;0;Create;True;0;0;False;0;False;5;2;0.01;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-1187.265,1834.013;Float;False;Property;_PulsationAmplitude;Pulsation Amplitude;18;0;Create;True;0;0;False;0;False;1;0.89;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-837.8602,-536.4207;Float;False;Property;_Maintextureintensity;Main texture intensity;2;0;Create;True;0;0;False;0;False;1;200;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;53;-793.3951,617.5067;Float;False;Property;_Secondarycolor;Secondary color;16;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0.5835142,0,4.241642,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;47;-875.6232,1379.375;Float;False;Property;_Edgecolor;Edge color;6;1;[HDR];Create;True;0;0;False;0;False;0.7941176,0.1284602,0.1284602,0.666;0,0.1428425,1.515717,0.666;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-882.9552,239.1608;Float;False;Property;_Secondarytextureintensity;Secondary texture intensity;13;0;Create;True;0;0;False;0;False;1;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;49;-862.1913,-176.4197;Float;False;Property;_Maincolor;Main color;5;1;[HDR];Create;True;0;0;False;0;False;0.7941176,0.1284602,0.1284602,0.666;0.01435995,0,1,0.666;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-745.5792,1871.441;Float;False;Property;_Enablepulsation;Enable pulsation;17;1;[Toggle];Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;369.7238,957.6937;Float;False;Property;_Globalopacity;Global opacity;0;0;Create;True;0;0;False;0;False;1;0.05;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;84;-2598.676,-474.0974;Inherit;False;Property;_MainTextureTiling;Main TextureTiling;21;0;Fetch;True;0;0;False;0;False;0,3;5,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=529D10DA9B741BDAF16268C8F640B0727D957078